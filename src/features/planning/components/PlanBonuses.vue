...
// Prop Watcher
watch(() => props.corphq, (newValue: boolean) => {
    localCorpHQ.value = newValue;
})

watch(() => props.cogc, (newValue: PLAN_COGCPROGRAM_TYPE) => {
...
<template>
    <n-form :disabled="disabled" label-placement="left" label-width="auto" label-align="left" size="small">
